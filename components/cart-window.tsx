      ...
      <div className="px-4 border-t">
        <div className="flex justify-between py-2 "> 
         ...
         <div className="flex flex-col gap-2 py-3">
           <button className="block py-3 text-sm uppercase border border-black outline-none cursor-pointer">CheckOut</button>
           <button className="block py-3 text-sm uppercase border border-black bg-[black] text-[white] cursor-pointer ">To cart</button>
         </div>
